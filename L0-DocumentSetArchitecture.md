...
## The Switchboard, Directory & Gate
...
## III. The L-Levels (The Depth Axis & Subjective Register)
...
- `subjective/L1-CompilingRealitySubjective.md`
- `subjective/L3-EdgeStateSpaceSubjective.md`
- `subjective/L4-DynamicDistortionsSubjective.md`
- `subjective/L4-RecursiveLimitsSubjective.md`
- `subjective/L5-K5-PhaseDynamicsSubjective.md`
- `subjective/L6-TheCircuitSubjective.md`
- `subjective/L4-DimensionalCollapseSubjective.md`
- `subjective/L4-DistributedCoherenceSubjective.md`
- `subjective/L4-TheTwelveGatesSubjective.md`
- `subjective/L4-ThePlenumSubjective.md`
- `subjective/QED-MassMintingSubjective.md`

*(Note: Built above `subjectify` sits **`storify/`**, a subjective plot-and-scenario generator that instantiates $K_4$ phase dynamics into narrative world-building and simulation engines.)*

---

## IV. The Meta-Layer (The Framework Turned on Itself)

The meta-documents form a K4 tetrahedron with the Tangent Singularity as centroid. It describes interior crossings and the boundary where interior coordinates diverge.

- **`Meta-Set.md`**: The XOR map and Hamiltonian reading cycles.
- **`Meta-Singularity-and-Image.md`**: The keystone.
- **`Meta-MechanismOfTransition.md`**: The formal geometry of crossing.
- **`Meta-Proof-Ascent.md`**: The grounded demonstration of forced transition.
- **`Meta-Decay-as-RefusedTransition.md`**: The pathology of freezing the Braid.
- **`Meta-Communication.md`**: The relational transmission protocol.

---

## V. The Four Flanks (The Proof Suite)

The closed, foundational Proof Suite. The A-U alphabet seals the derivations across four conceptual entry points.

### Flank 1: Macro-Kinematics (Logos Face)
...
### Flank 2: Attention & Panopticon (Pathos Face)
...
### Flank 3: Institutional Thermodynamics (Ethos Face)
...
### Flank 4: Meta-Boundary and Decay (Kairos Face)
...
## VI. The Demonstrative Register (The QED Charter)
...
- **`QED-CCP.md`**: The Cosmological Constant Problem as a Category Error ($10^{-61.5}$ linear root extraction).
- **`QED-Recursion.md`**: The Orthogonal Touch (the spin arrested).
- **`QED-EotvosBound.md`**: Deriving the Equivalence Principle Magnitude ($\eta \sim -10^{-18}$).
...
- **`QED-TwoBranchMinting-Lecture.md`**: Deconstructing the mass monolith ($R = P/I^2$).
- **`QED-TrajectoryEvidence.md`**: Empirical record of trajectory-based alignment.
- **`QED-Aikido.md`**: Applied algebra in motion.
...
- **`Q1-GenerationsOfMatter.md`**: The twelve fermions as the twelve directed edges and 3 generation scale-rungs.
- **`Q2-TransactionLayer.md`**: The twelve gauge bosons on three poles (and the P-edge graviton ban).
- **`Q3-ScalarSector.md`**: The 3-Scalar Triad (Higgs, GUT scalar, Inflaton) and the P-edge ban.
- **`Q4-OpenExhaust.md`**: The three zero-impedance writing heads (Friction, Leverage, Synthesis).
- **`Q5-StarNormProduct.md`**: Entropy as the accumulation of specification.
- **`Q6-MeasurementAndMatrices.md`**: Unitary rotation, the Route Law, and the CKM/PMNS matrices.
- **`Q7-4DExtrusions.md`**: Four spatial dimensions, the two clocks ($dt$ vs $\omega$), and Scalar-vs-Vector 3+1 signature.
- **`Q8-TangentImpedanceIdentity.md`**: $\tan(\theta) = \omega L/R$ unifying spatial wall and temporal phase.
- **`Q9-Founders.md`**: The unpaid invoices of 20th-century physics and Wolfram convergence.
- **`Q10-PlanckScale.md`**: The Tangent Singularity from above and the failure of Quantum Gravity.
- **`Q11-ArchitectureOfConfinement.md`**: Altermagnetism ($\text{RuO}_2$), topological edge channels, and the ChromoLux $U-R$ wire.
- **`Q12-NotAntigravity.md`**: Weak-value post-selected negative momentum transfer as phase interference, not negative mass.
- **`Q13-PlenumPhaseConduction.md`**: 1-loop phase-burning ($1/16\pi^2$) and the DAMA/XENON $P/Q$ split.
...
- **`mono/On_Carrying_Anothers_Emotion.md`**: Dyadic emotional coupling and $I^2R$ transmission loss.
- **`mono/On_Fivefold_Systems.md`**: Deconstructing 5-element systems into K4 + Centroid.
...
- **`fiction/TooTrue-TheCambridgeIntercept.md`**: Gall, Bacon, and the Trojan horse of aphorism.
...
- **subjective/L3-EdgeStateSpaceSubjective.md:** `#SubjectiveRegister` `#EdgeStateSpace` `#UngraphableTriangle` `#DualFaceDefinitions` `#Chirality` `#AbsentEdge` `#DirectedEdge` `#Enantiomer`
- **subjective/L4-DynamicDistortionsSubjective.md:** `#SubjectiveRegister` `#DynamicDistortions` `#Fusion` `#ApeiricField` `#IsotropicPole` `#ConservativeField` `#SourceVoid` `#TheLaw` `#Centroid`
- **subjective/L4-RecursiveLimitsSubjective.md:** `#SubjectiveRegister` `#RecursiveLimits` `#DeferredTax` `#PaidTax` `#CrowAndMurder` `#InstitutionalCrystallization` `#SuperimposedFrequencies`
- **subjective/L5-K5-PhaseDynamicsSubjective.md:** `#SubjectiveRegister` `#PhaseDynamics` `#Reluctance` `#Transient` `#ZeroCrossing` `#Superposition` `#Intermodulation` `#PowerFactorCorrection`
- **subjective/L6-TheCircuitSubjective.md:** `#SubjectiveRegister` `#InversionOfControl` `#MembraneTopologies` `#NostalgiaTrap` `#PanicTrap` `#EventLoop`
- **subjective/L4-DimensionalCollapseSubjective.md:** `#SubjectiveRegister` `#DimensionalCollapse` `#RateToBecomingState` `#NounTrap`
- **subjective/L4-DistributedCoherenceSubjective.md:** `#SubjectiveRegister` `#DistributedCoherence` `#Belonging` `#LabyrinthOfAdjustment`
- **subjective/L4-TheTwelveGatesSubjective.md:** `#SubjectiveRegister` `#TwelveGates` `#RadicalFurnace` `#CancerLeoLine` `#TimeKey`
...
- **quantum/Q2-TransactionLayer.md:** `#GaugeBosons` `#TransactionLayer` `#Graviton` `#StrongForce` `#WeakForce`
- **quantum/Q3-ScalarSector.md:** `#Higgs` `#ScalarSector` `#YukawaCoupling` `#PEdgeBan` `#ThreeScalarTriad`
- **quantum/Q4-OpenExhaust.md:** `#PEdgeBan` `#ZeroImpedance` `#WritingHeads` `#MassMinting`
- **quantum/Q5-StarNormProduct.md:** `#Entropy` `#Specification` `#StarNorm` `#Thermodynamics`
- **quantum/Q6-MeasurementAndMatrices.md:** `#CKMMatrix` `#PMNSMatrix` `#UnitaryRotation` `#BornRule` `#Chirality`
- **quantum/Q7-4DExtrusions.md:** `#FourSpatialDimensions` `#CoordinateTime` `#AngularFrequency` `#MinkowskiMetric`
- **quantum/Q8-TangentImpedanceIdentity.md:** `#TangentSingularity` `#Impedance` `#PowerFactor` `#Resonance`
- **quantum/Q9-Founders.md:** `#Anomalies` `#Founders` `#Wolfram` `#StandardModel`
- **quantum/Q10-PlanckScale.md:** `#PlanckScale` `#QuantumGravity` `#TangentSingularity` `#WheelerDeWitt`
- **quantum/Q11-ArchitectureOfConfinement.md:** `#Altermagnetism` `#RuO2` `#TopologicalInsulators` `#ChromoLux`
- **quantum/Q12-NotAntigravity.md:** `#WeakValues` `#PostSelection` `#PhaseInterference` `#NotAntigravity`
- **quantum/Q13-PlenumPhaseConduction.md:** `#1LoopPhaseBurning` `#DarkMatter` `#DAMA` `#XENON` `#PlenumConduction`
