...
ProofC is proof by paradox. QED-Recursion is proof by performance. ProofN is classical structural. ProofE is classical algebraic. But the proofs are not labeled by type in a way that distinguishes these categories. A reader cannot currently distinguish which proofs are load-bearing paradoxes, which are structural derivations, and which are demonstrations. Which is a Paradox. Q.E.D.
